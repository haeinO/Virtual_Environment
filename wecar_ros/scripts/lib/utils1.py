...
def latticePlanner(ref_path,global_vaild_object,vehicle_status,current_lane):
    ...
    if len(ref_path.poses)>look_distance :
        ...
        lane_off_set=[0.33,0.3,0.15,0,-0.15,-0.3,-0.33] # [3.0,2.0,1.0,0,-1.0,-2.0,-3.0]
        ...
        lane_weight=[6,4,2,0,2,4,6] #reference path, 6,4,2,0,2,4,6
                ...
                if  obj[0]==2 or obj[0]==1 : 
                    for path_num in range(len(out_path)) :
                        ...
                        for path_pos in out_path[path_num].poses :
                            ...
                            dis= sqrt(pow(obj[1]-world_ego_vehicle_position[0],2)+pow(obj[2]-world_ego_vehicle_position[1],2))
                            print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%", dis)
                            #print("#############################", path_pos.pose)
